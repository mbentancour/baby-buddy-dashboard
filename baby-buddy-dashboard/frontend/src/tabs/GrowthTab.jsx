...
export default function GrowthTab({
  ...
  const sleepDays = sleepSeries.filter(
    (d) => d.hours > 0
  );
      ...
      >
        ...
        <div className="fade-in fade-in-1">
          ...
          >
            ...
            >
              {latestWeight
                ? `${latestWeight.weight} ${units.weight}`
                : "—"}
            </div>
        ...
        <div className="fade-in fade-in-2">
          ...
          >
            ...
            >
              {latestHeight
                ? `${latestHeight.height} ${units.length}`
                : "—"}
            </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip
                        content={
                          <CustomTooltip
                            labelFormatter={formatGrowthTick}
                          />
                        }
                      />
